...
const db = require('./db');
const { getMatchingHandlers, handlers } = require('./handlers');
...
(async() => {
    ...
    // // console.log("INITIAL:", (await Resource.find({type: 'html', hash: '111140a5edc62f23591fdc348ddb44a5'})));
    // console.log("INITIAL:", (await Resource.find({type: 'html', 'meta.url': 'https://en.wikipedia.org/wiki/Caspar_Friedrich_Hachenberg'})))
